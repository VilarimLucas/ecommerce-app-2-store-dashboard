...
import axios from 'axios'; // Importar axios para realizar requisições
import logo from '../../assets/images/logo.png'; // Caminho para a logo
import product1 from '../../assets/images/product01.png'; // Caminho para o produto 1
import product2 from '../../assets/images/product02.png'; // Caminho para o produto 2
...
function Header() {
  ...
  const [products, setProducts] = useState([]); // Definir o estado de produtos
  ...
  const handleSearch = async (searchTerm) => {
    try {
      ...
      setProducts(res.data); // Atualizar o estado dos produtos
    } catch (err) {
